      ...
      <AnimatePresence>
        {isVideoOpen && (
          ...
          >
            ...
            >
              <motion.button className="absolute -top-16 right-0 text-foreground text-xl bg-background/80 ring-1 backdrop-blur-md p-2">
                <XIcon className="size-5" />
              </motion.button>
              <div className="size-full border-2 border-border overflow-hidden isolate z-[1] relative">
                <iframe
                  src={videoSrc}
